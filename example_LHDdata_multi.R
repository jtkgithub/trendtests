...
CvMtest_multi1(SBdatalist,weights="sqrtNCV",sigma="s",Npsim=10000)
CvMtest_multi2(SBdatalist,weights="sqrtNCV",sigma="s")
ADtest_multi1(SBdatalist,weights="sqrtNCV",sigma="s",Npsim=10000)
ADtest_multi2(SBdatalist,weights="sqrtNCV",sigma="s")
